                ...
                ConvertUtils.register(new Converter() {
                          ...
                          public Object convert(Class clazz, Object value) {
                              ...
                              try {
                                  ...
                                  parse = (java.util.Date) format.parse(value.toString());
...
//                            .toLowerCase(), rs.getObject(i));
                    System.out.println(toCamelCase(metadata.getColumnLabel(i))+","+rs.getObject(i));
                    BeanUtils.setProperty(obj, toCamelCase(metadata.getColumnLabel(i)),
                            rs.getObject(i));
                }
                // 将每条记录的对象存放至list集合中
                list.add(obj);
